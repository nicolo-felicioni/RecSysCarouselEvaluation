...
def ndcg(ranked_list, pos_items, relevance=None):
    ...
    rank_scores = np.asarray([it2rel.get(it, 0.0) for it in ranked_list], dtype=np.float32)
...
class Diversity_MeanInterList(_Metrics_Object):
    ...
    Maurizio Ferrari Dacrema. 2021. "Demonstrating the Equivalence of List Based and Aggregate Metrics to Measure the Diversity of Recommendations(Student Abstract)."
